...
const AdminDashboard = () => {
  ...
  // Handle download file pengumuman
        ...
        <div className="space-y-3 sm:space-y-4">
          {loadingPengumuman ? (
            ...
            pengumuman.map((item) => (
              ...
              >
                <h2 className="text-base sm:text-lg md:text-xl font-semibold">{item.judul_pengumuman}</h2>
                <p className="text-xs sm:text-sm text-blue-500">{formatDate(item.tanggal_pengumuman)}</p>
                <p className="text-xs sm:text-sm md:text-base text-gray-700 mt-2">{item.isi_pengumuman}</p>
